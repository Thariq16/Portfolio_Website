export const POSTS = [
{num:1, date:"Tue, Jul 7, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience",
 ...
 body:`I was Product Lead on a product that ran for six years. A trust breakdown triggered a social backlash, and user activity went from normal to zero in about six weeks.

I'm not naming it. The specifics aren't the point. There's no tidy resolution here: the product is on hibernation now, user data deleted, platform made inaccessible.

Six years of work, gone in six weeks.

For a long time I thought the point of telling a story like this was showing that you recovered. I don't think that anymore. The point is just being honest that it happened, and what it actually taught me. It taught me more about product management than any course you can find in this world.

Being a Product Lead of a failed product is a blessing you can have in your career because success teaches you a few things, failure teaches you many that you can avoid in the next stage. I didn't understand how literally true that was until I lived through it.

What's the version of this you haven't told yet?`,
 hashtags:"#ProductManagement #ProductLeadership #Vision2030 #SaudiArabia",
 note:"Seventh pass, 2026-07-08: rebuilt from scratch per Thariq's request, rather than another incremental edit. Two new standing rules applied, now in PBOS/EDITORIAL/01_Writing_DNA.md: (1) no em dashes anywhere, replaced with periods, commas, or colons; (2) a post can end on a genuine, specific question about the reader's own experience to invite response without an explicit 'comment below'-style ask. Both verbatim quotes kept exactly as facts-source.md records them, role corrected to Product Lead per the sixth pass. Closing question is new and ties to the post's own framing rather than making a claim about the reader, unlike the two previously-cut closers. Prior history: moved to Post 1/opener 2026-07-05, no anonymization gymnastics needed. Correction 2026-07-06: an earlier pass wrongly flattened the verbatim quote into generic paraphrase; restored from facts-source.md's CLEARED section. Second correction same day: rewrote surrounding paragraphs to break a rhythm pattern a human reviewer flagged as AI-polished. Sixth pass, 2026-07-08 (Thariq's own correction): 'Head of Product' to 'Product Lead' throughout, factual fix since he was co-founder; closing paragraph cut for stated-lesson/second-person issue. This seventh pass supersedes the sixth pass's patches with a full rewrite.",
 diff:[
   ["I was Product Lead on something that ran for six years, and then a trust breakdown triggered a social backlash and user activity went from normal to zero in about six weeks. I'm not going to name it. The specifics aren't really the point, and I'm not turning this into a case study with a tidy resolution because there isn't one, the product's on hibernation now, user data deleted, platform made inaccessible.","I was Product Lead on a product that ran for six years. A trust breakdown triggered a social backlash, and user activity went from normal to zero in about six weeks.\\n\\nI'm not naming it. The specifics aren't the point. There's no tidy resolution here: the product is on hibernation now, user data deleted, platform made inaccessible."],
   ["I used to think the value in telling a story like this was showing that you recovered. I don't really think that anymore. I think the value is just being honest that it happened and what it actually taught me, and it taught me more than any course or mentor or anything else has.","For a long time I thought the point of telling a story like this was showing that you recovered. I don't think that anymore. The point is just being honest that it happened, and what it actually taught me. It taught me more about product management than any course you can find in this world."],
   ["Being the Product Lead on a failed product is a blessing you can have in your career, because success teaches you a few things, failure teaches you many that you can avoid in the next stage. I don't think I understood how literally true that was until I'd actually lived through it.","Being a Product Lead of a failed product is a blessing you can have in your career because success teaches you a few things, failure teaches you many that you can avoid in the next stage. I didn't understand how literally true that was until I lived through it.\\n\\nWhat's the version of this you haven't told yet?"]
 ]},

{num:2, date:"Thu, Jul 9, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"KSA Product Reviews", type:"Authority",
...
None of this is a small-team-can't-do-it problem. It's a "which metric are we actually optimizing" problem, and right now it looks like the metric is match speed, not match confidence. Those aren't really the same thing, and I think riders can tell the difference even if they couldn't put a name to it.`,
 ...
 diff:[
   ["Both complaints point at the same underlying gap: the live-tracking feature is built to show position, not to show confidence in that position.","Both complaints point at the same underlying gap, I think — the live-tracking feature shows position, but it doesn't show confidence in that position."],
   ["Those aren't the same thing, and riders can tell the difference even when they can't name it.","Those aren't really the same thing, and I think riders can tell the difference even if they couldn't put a name to it."]
 ]},

{num:3, date:"Sun, Jul 12, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"AI & Product Development", type:"Authority (was Post 5)",
...
It's the one I end up spending as much design time on as the model itself, if I'm honest.`,
 ...
 diff:[
   ["It's the question I now spend as much design time on as the model itself.","It's the one I end up spending as much design time on as the model itself, if I'm honest."]
 ]},

{num:4, date:"Tue, Jul 14, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience",
...
The model never actually got smarter through any of this. What changed was what the user could see. Trust is a product feature, not an engineering metric.`,
 ...
 diff:[
   ["That's what turned it around. Once people could see why an answer deserved trust, not just that it sounded confident, usage started moving.","That's what actually turned it around — once people could see why an answer deserved trust, not just that it sounded confident, usage started moving."],
   ["The model never got smarter during any of this. What changed was what the user could actually see.","The model never actually got smarter through any of this. What changed was what the user could see."]
 ]},

{num:5, date:"Thu, Jul 16, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience (was Post 7)",
...
By the time the bikes actually arrived, I wasn't the same product lead who'd joined. I was assigned the full application design — website, inventory system, rider app — because I'd used the delay to actually understand what I was building, not just manage it.`,
 hashtags:"#ProductManagement #ProductLeadership #Vision2030 #SaudiArabia",
 note:"Source: Sling Mobility Story.docx, read in full 2026-07-05. Real, specific, dated — no invented figures. PBOS fix 2026-07-06: removed \"The lesson I keep coming back to:\" label, reworded as first-person reflection. Second pass, same day: loosened closing rhythm per the batch-wide 'sounds like AI' fix. Fifth pass, 2026-07-08 (Thariq's own catch): the closing sentence still stated the lesson in generalized epigram form even after being loosened into a run-on — cut entirely per Quality Checklist's 'can readers reach the conclusion themselves?' Post now ends on the concrete outcome instead.",
 diff:[
   ["A blocker I couldn't control turned out to still be time I controlled. What I did inside it was the only part that was ever up to me.","A blocker I couldn't control turned out to still be time I controlled, and what I did inside it was really the only part that was ever up to me."],
   ["...because I'd used the delay to actually understand what I was building, not just manage it. A blocker I couldn't control turned out to still be time I controlled, and what I did inside it was really the only part that was ever up to me.","...because I'd used the delay to actually understand what I was building, not just manage it. [closing sentence cut entirely]"]
 ]},

{num:6, date:"Sun, Jul 19, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Potential in the Market", type:"Authority",
...
The part I don't see many companies treating as a product problem yet: who owns and services this infrastructure inside a compound or a campus, not just who installs the charger. Public charging still matters for tourism and event-driven demand, but if this were my roadmap, that operational layer is where I'd actually build — a narrower, more specific bet than just "EVs are growing, so charging companies win."`,
 hashtags:"#ProductManagement #ProductLeadership #Vision2030 #SaudiArabia",
 links:[["EVIQ to complete 60 EV charging stations by end of 2025, focus shifts to highways — Arab News","https://www.arabnews.com/node/2621290/business-economy"],["ABB supplies EV chargers for residential compound in Saudi Arabia — ABB official news center","https://new.abb.com/news/detail/67379/abb-supplies-ev-chargers-for-residential-compound-in-saudi-arabia"]],
 ...
 diff:[
   ["That operational layer is the actual opportunity — and it's a narrower, more specific bet than \"EVs are growing, therefore charging companies win.\"","That operational layer is the real opportunity, I think — a narrower, more specific bet than just \"EVs are growing, so charging companies win.\""],
   ["That operational layer is the real opportunity, I think — a narrower, more specific bet than just \"EVs are growing, so charging companies win.\"","If this were my roadmap, that operational layer is where I'd actually build — a narrower, more specific bet than just \"EVs are growing, so charging companies win.\""],
   ["...and dense urban districts where residence density is high but road capacity isn't...","...and dense urban districts where, in my read, road capacity hasn't kept pace with residence density..."],
   ["...not just who installs the charger. If this were my roadmap, that operational layer...","...not just who installs the charger. Public charging still matters for tourism and event-driven demand, but if this were my roadmap, that operational layer..."]
 ]},

{num:7, date:"Tue, Jul 21, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"AI & Product Development", type:"Experience (was Post 11)",
...
A capability being technically real never meant it was ready to ship — the harder, less glamorous work was always figuring out who got to ask the question in the first place. That's not a problem you solve once, either — every new use case for the same underlying tool reopens it.`,
 ...
 diff:[
   ["A capability being technically real never meant it was ready to ship. The harder, less glamorous work was always deciding who got to ask the question in the first place.","A capability being technically real never meant it was ready to ship — the harder, less glamorous work was always figuring out who got to ask the question in the first place."],
   ["...the harder, less glamorous work was always figuring out who got to ask the question in the first place.","...in the first place. That's not a problem you solve once, either — every new use case for the same underlying tool reopens it."]
 ]},

{num:8, date:"Thu, Jul 23, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"KSA Product Reviews", type:"Authority (expected)",
...
{num:9, date:"Sun, Jul 26, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Growing Technology", type:"Belief (was Post 3)",
...
If it were my roadmap, trust and auditability would be built in from day one, not bolted on after a launch built for somewhere else — that's a product strategy call before it's ever an engineering one.`,
 ...
 diff:[
   ["The products that actually win enterprise adoption in this region will be the ones designed around trust and auditability from day one, not accuracy metrics bolted on after a Silicon Valley launch.","The products that actually win here, I think, will be the ones built around trust and auditability from day one — not accuracy metrics bolted on after they've already launched somewhere else."],
   ["...and accountability is what actually blocks enterprise buy-in... / The products that actually win here... / That's a product strategy problem before it's an engineering one.","...and if I were leading product on one of these tools, accountability is what I'd want solved before accuracy... / If it were my roadmap, trust and auditability would be built in from day one, not bolted on after a launch built for somewhere else — that's a product strategy call before it's ever an engineering one."]
 ]},

{num:10, date:"Tue, Jul 28, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"AI & Product Development", type:"Experience (was Post 17)",
...
{num:11, date:"Thu, Jul 30, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience (was Post 10)",
...
Six years, one research project, two countries — still the clearest example I've got of what "founder-level ownership" actually means, day to day.`,
 ...
 diff:[
   ["Six years, one research project, two countries. Still the clearest example I have of what \"founder-level ownership\" actually means day to day.","Six years, one research project, two countries — still the clearest example I've got of what \"founder-level ownership\" actually means, day to day."]
 ]},

{num:12, date:"Sun, Aug 2, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Growing Technology", type:"Authority (was Post 9)",
...
Vehicle class first, infrastructure model second — that's the order I'd insist on, because getting it backwards is an expensive mistake once the hardware's already in the ground.`,
 ...
 diff:[
   ["The mistake I've seen repeated is choosing an infrastructure model based on which one is more exciting to announce, rather than which one matches the actual utilization pattern of the vehicle class being deployed.","The mistake I keep seeing is picking an infrastructure model because it's more exciting to announce, rather than because it actually matches how the vehicle class gets used."],
   ["The pattern I keep seeing is infrastructure model getting decided before vehicle class does — and that's an expensive order to reverse once the hardware's already in the ground.","Infrastructure model keeps getting decided before vehicle class does, and that's an expensive order to get backwards once the hardware's already in the ground."],
   ...
   ["Infrastructure model keeps getting decided before vehicle class does, and that's an expensive order to get backwards once the hardware's already in the ground.","Vehicle class first, infrastructure model second — that's the order I'd insist on, because getting it backwards is an expensive mistake once the hardware's already in the ground."]
 ]},

{num:13, date:"Tue, Aug 4, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience (was Post 12)",
...
Unglamorous, physical, get-your-hands-on-the-hardware decisions are usually the ones that end up deciding whether a product ships at the quality it actually needs — that's been true on pretty much everything I've built since.`,
 ...
 diff:[
   ["None of that shows up on a product roadmap slide. All of it is the actual work of taking an idea from \"this should work in theory\" to \"this is safe and fast enough that a rider trusts it without thinking twice.\" ... The unglamorous, physical, get-your-hands-on-the-hardware decisions are usually the ones that determine whether a product ships at the quality it actually needs.","None of that shows up on a product roadmap slide, but it's the actual work of taking an idea from \"this should work in theory\" to \"this is safe and fast enough that a rider trusts it without thinking twice.\" ... Unglamorous, physical, get-your-hands-on-the-hardware decisions are usually the ones that end up deciding whether a product ships at the quality it actually needs — that's been true on pretty much everything I've built since."]
 ]},

{num:14, date:"Thu, Aug 6, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Potential in the Market", type:"Experience (was Post 13)",
...
Most EV infrastructure conversations stop at charging versus swapping, but the question I'd keep asking on any team building this is who owns the asset once you've built the network — and whether the business is actually designed to answer that.`,
 ...
 diff:[
   ["Most EV infrastructure conversations stop at charging versus swapping. The bigger question is who owns the asset once you've built the network — and whether you've designed your business to answer that question at all.","Most EV infrastructure conversations stop at charging versus swapping, but the bigger question, I think, is who owns the asset once you've built the network — and whether you've actually designed your business to answer that."],
   ["Most EV infrastructure conversations stop at charging versus swapping, but the bigger question, I think, is who owns the asset once you've built the network — and whether you've actually designed your business to answer that.","Most EV infrastructure conversations stop at charging versus swapping, but the question I'd keep asking on any team building this is who owns the asset once you've built the network — and whether the business is actually designed to answer that."],
   ["That's a genuinely different business once you make that shift — the batteries stop being infrastructure you own...","That's a genuinely different business once you make that shift, and a harder one to run — the batteries stop being infrastructure you own..."]
 ]},

{num:15, date:"Sun, Aug 9, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Growing Technology", type:"Authority",
...
This is the part of enterprise AI adoption in this region I'd want any product I led to get right early — not the only blocker, but one I'd never leave unanswered. In my experience, buyers here often aren't asking "can the model do this" first — they're asking "who else can see my data if I say yes to this," and if I couldn't answer that cleanly, with real architecture behind the answer rather than a compliance slide, I'd expect the deal to stall no matter how good the model actually was.`,
 ...
 diff:[
   ...
   ["This is the part of enterprise AI adoption in this region that doesn't get talked about enough, I think. ... any product that can't answer that cleanly ... is going to stall no matter how good the underlying model actually is.","This is the part of enterprise AI adoption in this region I'd want any product I led to get right early. ... if I couldn't answer that cleanly ... I'd expect the deal to stall no matter how good the model actually was."],
   ["This is the part of enterprise AI adoption in this region I'd want any product I led to get right early. Serious buyers here aren't usually asking...","This is the part of enterprise AI adoption in this region I'd want any product I led to get right early — not the only blocker, but one I'd never leave unanswered. In my experience, buyers here often aren't asking..."]
 ]},

{num:16, date:"Tue, Aug 11, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience (was Post 14)",
...
Testing only with people who already get the pitch isn't really testing the UX, if I'm honest — it's testing the pitch, and those two things get confused more often than they should.`,
 ...
 diff:[
   ["Testing only with people who already get the pitch isn't testing the UX. It's testing the pitch.","Testing only with people who already get the pitch isn't really testing the UX, if I'm honest — it's testing the pitch, and those two things get confused more often than they should."]
 ]},

{num:17, date:"Thu, Aug 13, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"AI & Product Development", type:"Belief (was Post 19)",
...
{num:18, date:"Sun, Aug 16, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience (was Post 16)",
...
The discount got us in the room, but the 90% number is what actually kept the deal there once we were in it.`,
 ...
 diff:[
   ["The discount got us in the room. The 90% number is what kept the deal there.","The discount got us in the room, but the 90% number is what actually kept the deal there once we were in it."]
 ]},

{num:19, date:"Tue, Aug 18, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Personal Experiences", type:"Experience (was Post 18)",
...
{num:20, date:"Thu, Aug 20, 2026", time:"8:00–10:00 AM AST", track:"Builder", pillar:"Potential in the Market", type:"Belief",
...
Sports analytics and enterprise product work share more of a spine than people expect, I've found — both come down to building something that earns trust fast enough to actually get used before the moment it mattered has already passed.`,
 ...
 diff:[
   ["Sports analytics and enterprise product work share more of a spine than people expect. Both come down to building something that earns trust fast enough to actually get used before the moment it mattered has passed.","Sports analytics and enterprise product work share more of a spine than people expect, I've found — both come down to building something that earns trust fast enough to actually get used before the moment it mattered has already passed."]
 ]},
...
That's the layer of performance analysis I actually want to spend a career on — less what won the match, more what kept the team available to compete in the next one.`,
 ...
 diff:[
   ["That's the layer of performance analysis I actually want to spend a career on. Not just what won the match, but what kept the team available to compete in the next one.","That's the layer of performance analysis I actually want to spend a career on — less what won the match, more what kept the team available to compete in the next one."]
 ]},
...
{num:24, date:"Sun, Jul 12, 2026", time:"8:00–10:00 AM AST", track:"Analyst", pillar:"Crossover — Credibility & Process", type:"Experience",
 title:"First season at Glacis United FC — recap and the platform I built", status:"Ready", format:"Text-only", image:false, score:8.8,
