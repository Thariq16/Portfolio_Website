...
// Synced 2026-08-03 against the updated source: reordered posts, actual publish dates/times for posts 1/4/24,
// rewritten bodies and notes, and new Post 25 (ad-hoc reactive post, self-written and self-published by Thariq).
...
export const posts: Post[] = [
    {
        num: 1, date: 'Thu, Jul 9, 2026', time: '7:14 AM AST', track: 'Builder', pillar: 'Personal Experiences',
        title: 'Failed product story: OPENER', status: 'Ready', format: 'Text-only', image: false, score: 9.5,
        why: 'Strongest hook in the batch, fully cleared, no anonymization needed: recommended opener. Actually published Thu Jul 9 (planned Jul 7, slipped two days), actual publish order: 1st of 3 posts published so far.',
...
None of this is a small-team-can't-do-it problem. It's a "which metric are we actually optimizing" problem, and right now it looks like the metric is match speed, not match confidence. Those aren't really the same thing, and I think riders can tell the difference even if they couldn't put a name to it.`,
    ...
    {
        num: 3, date: 'Sun, Jul 12, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'AI & Product Development',
...
It's the one I end up spending as much design time on as the model itself, if I'm honest.`,
    ...
    {
        num: 4, date: 'Wed, Jul 15, 2026', time: '7:35 AM AST', track: 'Builder', pillar: 'Personal Experiences',
        title: 'RAGAS/trust pivot (employer anonymized)', status: 'Ready', format: 'Single image (AI-generated infographic)', image: true, score: 8.2,
        why: 'Strong, real craft story (RAGAS/trust score/thumbs up-down): held back from opener only because the anonymization reads more abstract as a cold open. Actually published Wed Jul 15 (planned Jul 14, slipped one day), actual publish order: 3rd of 3 posts published so far, after Post 24 (Glacis, Jul 12).',
...
The model never actually got smarter through any of this. What changed was what the user could see. Trust is a product feature, not an engineering metric.`,
    ...
    {
        num: 5, date: 'Thu, Jul 16, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'Personal Experiences',
...
The part I don't see many companies treating as a product problem yet: who owns and services this infrastructure inside a compound or a campus, not just who installs the charger. Public charging still matters for tourism and event-driven demand, but if this were my roadmap, that operational layer is where I'd actually build: a narrower, more specific bet than just "EVs are growing, so charging companies win."`,
    ...
    {
        num: 7, date: 'Tue, Jul 21, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'AI & Product Development',
        title: 'Capability vs. governance: the HR/PII insight problem', status: 'Ready', format: 'Text-only', image: false, score: 8,
...
If it were my roadmap, trust and auditability would be built in from day one, not bolted on after a launch built for somewhere else: that's a product strategy call before it's ever an engineering one.`,
    ...
    {
        num: 10, date: 'Tue, Jul 28, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'AI & Product Development',
...
A sales motion that depends on data compounding over time has to prove the curve, not just the starting point, and that's the part I never actually solved.`,
    ...
    {
        num: 11, date: 'Thu, Jul 30, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'Personal Experiences',
...
Six years, one research project, two countries: still the clearest example I've got of what "founder-level ownership" actually means, day to day.`,
    ...
    {
        num: 12, date: 'Sun, Aug 2, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'Growing Technology',
...
Vehicle class first, infrastructure model second: that's the order I'd insist on, because getting it backwards is an expensive mistake once the hardware's already in the ground.`,
    ...
    {
        num: 13, date: 'Tue, Aug 4, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'Personal Experiences',
...
Unglamorous, physical, get-your-hands-on-the-hardware decisions are usually the ones that end up deciding whether a product ships at the quality it actually needs: that's been true on pretty much everything I've built since.`,
    ...
    {
        num: 14, date: 'Thu, Aug 6, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'Potential in the Market',
...
The discount got us in the room, but the 90% number is what actually kept the deal there once we were in it.`,
    ...
    {
        num: 19, date: 'Tue, Aug 18, 2026', time: '8:00–10:00 AM AST', track: 'Builder', pillar: 'Personal Experiences',
...
That's the layer of performance analysis I actually want to spend a career on: less what won the match, more what kept the team available to compete in the next one.`,
...

    {
        ...
        title: 'Barça Innovation Hub & FA coaching credentialing', status: 'Not Cleared', format: 'Text-only', image: false, score: 5,
...
Credentialing myself on the coaching side of the game has mattered more to how I read the data than getting better at the tools ever did.`,
    ...
    {
        num: 24, date: 'Sun, Jul 12, 2026', time: '8:00–10:00 AM AST', track: 'Analyst', pillar: 'Crossover: Credibility & Process',
        title: 'First season at Glacis United FC: recap and the platform I built', status: 'Ready', format: 'Text + PDF document (10 pages)', image: false, score: 8.8,
        why: "Extremely specific numbers, honest trade-off reasoning (budget and facility constraints named together, not oversimplified to one cause), and a concrete build log (MVP through V0.3). Written by Thariq himself, not a Claude draft; this pass fixed em dashes, three stated-conclusion lines, and a factual correction on Gibraltar's ground count. Published Sun Jul 12 at 10:05 AM as planned, with a 10-page PDF attached. Actual publish order: 2nd of 3 posts published so far, between Post 1 (Jul 9) and Post 4 (Jul 15).",
...
First season done. A lot learned. Nowhere near finished.`,
    ...
    {
        num: 25, date: 'Fri, Jul 31, 2026', time: '11:28 AM AST', track: 'Builder', pillar: 'AI & Product Development',
        title: "LinkedIn's \"Seems like AI slop\" flagging feature: opinion/analysis", status: 'Ready', format: 'Text + PDF document (4 pages)', image: false, score: 7.4,
        why: "Ad-hoc reactive post, not part of the original batch, written and published by Thariq himself the same day LinkedIn's \"Seems like AI slop\" flag launched, no Claude draft or PBOS pass before posting. Real, balanced, timely opinion piece with a clear structural argument (two risks, one fair counterpoint, a genuine closing question) rather than a hot take. Real analytics, checked 3 days after publish: 299 impressions, 163 members reached, 3 reactions, 0 comments. Best KSA representation of any post tracked so far: 5% Riyadh region, versus 2%, 0%, and 0% on the other three tracked posts, likely because this is Authority-type commentary with zero Sri Lanka framing, unlike most of the batch.",
        body: `LinkedIn just released the "Seems like AI slop" button, letting users flag posts they believe are AI generated. As a Product Manager, I think the intent is right but the execution carries real risk.

Two things stand out to me.

1. Flagging can be weaponized. A well written competitor post can get reported simply because it performs well, not because it is actually an AI slop.

2. The line between "I wrote this and used AI to tighten it up" and "this is fully AI generated" is blurry. Even LinkedIn's own CPO admits AI detection still gets it wrong sometimes.

To be fair, LinkedIn seems aware of this. Flagged posters get a quiet heads up in their own analytics rather than a public label, and they are retiring their AI writing tool for a proofreading only feature that preserves a user's voice. That is a smarter middle ground than I expected.

Still, trust features live or die on how they get abused, not how they were intended. The real test will be what happens to the first wave of falsely flagged creators.

What's your take?`,
        hashtags: '#SaudiArabia #LinkedIn #ProductManagement #TrustAndSafety #NewFeature',
        note: "Self-written and self-published by Thariq, 2026-07-31, in direct reaction to LinkedIn's real feature launch, not drafted or edited by Claude before posting, so no PBOS pass or diff exists for it. Brought to Claude on 2026-08-03 to log its real analytics into post-performance-log.xlsx, performance-analysis.html, and PBOS/EXECUTION/03_Knowledge_Evolution.md, and added here for completeness. Hashtag set deliberately different from the standard batch signature (#ProductLeadership #Vision2030 #SaudiArabia): this one is topic-specific (#TrustAndSafety, #NewFeature) rather than the recurring four, worth noting if a consistent hashtag signature matters going forward. Structural note: two numbered risks, one fair counterpoint, one genuine closing question: closer to the batch's Authority-post shape than a hot take, despite being written fast and same-day.",
        posted: true,
    },
];
